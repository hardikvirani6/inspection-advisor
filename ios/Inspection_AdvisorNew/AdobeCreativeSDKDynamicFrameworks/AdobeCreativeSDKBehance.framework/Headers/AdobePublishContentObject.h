...
#ifndef AdobePublishContentObjectHeader
#define AdobePublishContentObjectHeader

#if defined(ADOBEPUBLISH_EXTENSION) && !defined(ADOBEPUBLISH_TVOS)
#import <AdobeCreativeSDKBehanceExtension/AdobePublishBaseModel.h>
#import <AdobeCreativeSDKBehanceExtension/AdobePublishServices.h>
#else
