...
#ifndef AdobePublishCommentHeader
#define AdobePublishCommentHeader

NS_ASSUME_NONNULL_BEGIN

@class AdobePublishUser;
@class AdobePublishCommentTag;
...
/**
 Array of user tags (ex. "@John Smith") contained within the comment
 */
@property (nullable, nonatomic, strong) NSArray<AdobePublishCommentTag *> * userTags;
