...
#ifndef AdobePublishTeamHeader
#define AdobePublishTeamHeader
 ...
 */
+ (AdobePublishNetworkTask *)teamsSearchWithParams:(nullable NSDictionary<NSString *, NSString *> *)params completion:(AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (nullable AdobePublishNetworkTask *)teamsAutocompleteWithText:(NSString *)autocompleteText completion:(AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (AdobePublishNetworkTask *)teamWithIdentifier:(NSString *)teamIdentifier completion:(AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (AdobePublishNetworkTask *)membersForTeamWithIdentifier:(NSString *)teamIdentifier params:(nullable NSDictionary<NSString *, NSString *> *)params completion:(AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (AdobePublishNetworkTask *)projectsForTeamWithIdentifier:(NSString *)teamIdentifier params:(nullable NSDictionary<NSString *, NSString *> *)params completion:(AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion      `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (AdobePublishNetworkTask *)currentUserProjectAssociationsForTeamWithIdentifier:(NSString *)teamIdentifier offset:(nullable NSNumber *)offset completion:(AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (nullable AdobePublishNetworkTask *)updateProjectsForTeamWithIdentifier:(NSString *)teamIdentifier projectIdsToAdd:(NSArray<NSNumber *> *)projectIdsToAdd projectIdsToRemove:(NSArray<NSNumber *> *)projectIdsToRemove completion:(nullable AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (nullable AdobePublishNetworkTask *)followTeamWithIdentifier:(NSString *)teamIdentifier completion:(nullable AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (nullable AdobePublishNetworkTask *)unfollowTeamWithIdentifier:(NSString *)teamIdentifier completion:(nullable AdobePublishNetworkResponseCompletion)completion;
