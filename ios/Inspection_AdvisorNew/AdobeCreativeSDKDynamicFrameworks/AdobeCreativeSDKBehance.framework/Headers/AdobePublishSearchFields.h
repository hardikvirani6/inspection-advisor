...
#ifndef AdobePublishSearchFieldsHeader
#define AdobePublishSearchFieldsHeader

NS_ASSUME_NONNULL_BEGIN

@class AdobePublishSearchField;
 ...
 */
+ (AdobePublishNetworkTask *)creativeFieldsWithCompletion:(AdobePublishNetworkResponseCompletion)completion;
