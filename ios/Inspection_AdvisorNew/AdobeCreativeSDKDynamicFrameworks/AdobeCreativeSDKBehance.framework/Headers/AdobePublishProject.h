...
#ifndef AdobePublishProjectHeader
#define AdobePublishProjectHeader

NS_ASSUME_NONNULL_BEGIN

@class AdobePublishTool;
...
/**
 Array of project cover image URLs
 ...
 */
@property (nonatomic, strong) NSArray<NSURL *> * coverImageURLs;
 ...
 */
@property (nonatomic, strong) NSArray<AdobePublishTool *> * toolsUsed;
...
/**
 Indicates whether the project owner has disabled project comments / commenting
 */
@property (nonatomic, getter=isCommentingDisabled) BOOL commentingDisabled;
...
*/
+ (AdobePublishNetworkTask *)projectsSearchWithParams:(nullable NSDictionary<NSString *, id> *)params completion:(AdobePublishNetworkResponseCompletion)completion;

/*
 Get project drafts for the currently authenticated user.
 @param params `NSDictionary` of parameters to supply to the API. (see http://behance.net/dev for up-to-date information)
 */
+ (AdobePublishNetworkTask *)draftsWithParams:(nullable NSDictionary<NSString *, id> *)params completion:(AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (AdobePublishNetworkTask *)projectWithId:(NSNumber *)projectId completion:(AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (NSArray<AdobePublishNetworkTask *> *)projectsWithIds:(NSArray<NSNumber *> *)projectIds completion:(AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (AdobePublishNetworkTask *)commentsForProjectWithId:(NSNumber *)projectId page:(NSNumber *)page params:(nullable NSDictionary<NSString *, id> *)params completion:(AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (nullable AdobePublishNetworkTask *)userCollectionsContainingProjectWithId:(NSNumber *)projectId completion:(AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (AdobePublishNetworkTask *)viewProjectWithId:(NSNumber *)projectId completion:(nullable AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (nullable AdobePublishNetworkTask *)postComment:(NSString *)comment projectId:(NSNumber *)projectId completion:(nullable AdobePublishNetworkResponseCompletion)completion;
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (AdobePublishNetworkTask *)appreciateProjectWithId:(NSNumber *)projectId completion:(nullable AdobePublishNetworkResponseCompletion)completion;

/*
 Un-appreciates the project from the current user.
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (AdobePublishNetworkTask *)unappreciateProjectWithId:(NSNumber *)projectId completion:(nullable AdobePublishNetworkResponseCompletion)completion NS_SWIFT_NAME(unappreciate(withId:completion:));
...
/*
 ...
 @param completion `AdobePublishNetworkResponseCompletion` callback for the API request
 */
+ (nullable AdobePublishNetworkTask *)deleteCommentWithId:(NSNumber *)commentId projectId:(NSNumber *)projectId completion:(nullable AdobePublishNetworkResponseCompletion)completion;
