...
#ifndef AdobePublishProjectViewDelegateHeader
#define AdobePublishProjectViewDelegateHeader
...
/**
 Called when the user initiates project unappreciation.
 The component handles making the unappreciate network request.
 */
- (void)projectWillUnappreciate;

/**
 Called when project unappreciation initiated by the user has completed successfully.
 */
- (void)projectUnappreciateSucceeded;

/**
 Called when project unappreciation initiated by the user fails.
 @param error an error describing why the unappreciate request failed
 */
- (void)projectUnappreciateFailed:(NSError *)error;
