...
#ifndef AdobePublishHeader
#define AdobePublishHeader
...
/**
 ...
 Content can be published as a Project: a composed piece, including one or more images/video embeds, and a cover image
