...
typedef NS_ENUM (NSInteger, AdobeAuthErrorCode)
{
    ...
    /** Indicates that Facebook token has expired. DEPRECATED: Use AdobeAuthErrorCodeSocialProviderTokenExpired instead.*/
    ...
    /** Indicates that User did not provide sufficient permissions. DEPRECATED: Use AdobeAuthErrorCodeSocialProviderInsufficientPermissions instead.*/
    AdobeAuthErrorCodeFacebookInsufficientPermissions = 16,
    
    /** Indicates that User did not provide sufficient permissions. */
    AdobeAuthErrorCodeSocialProviderInsufficientPermissions = 17,
    
    /** Indicates that Google token has expired. */
    AdobeAuthErrorCodeSocialProviderTokenExpired = 18,
    
    /** Indicates an unknown IMS error for social sign in. */
    AdobeAuthErrorCodeSocialProviderUnknownError = 19,
