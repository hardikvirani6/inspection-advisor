...
/**
 * This class allows you to create (or edit) a layer comp. You can define which layers should be 
 * visible when the comp is applied.
 */
__deprecated_msg("Creating/Modifying Layer Comps is no longer supported.")
