...
/**
 * Specifies whether or not bookmarked libraries should be synced and returned in the list of libraries.
 * Default is YES.
 */
@property (nonatomic) BOOL includeBookmarkedLibraries;

/**
 * Specifies whether or not local libraries should be returned in the list of libraries. Local libraries should not be shown to the user. 
 * They are not synched to the server
 * Default is NO.
 */
@property (nonatomic) BOOL includeLocalLibraries;
