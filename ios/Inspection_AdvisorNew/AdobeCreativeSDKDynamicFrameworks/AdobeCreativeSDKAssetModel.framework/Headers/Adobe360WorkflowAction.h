...
/**
 * Collection of accepted Internet Media Types. Array of NSString objects
 * Examples of Internet Media Type include "image/png", "image/jpeg" etc.
 *
 * @see AdobeAssetMimeTypes for more information
 */
 ...
 * Examples of Internet Media Type include "image/png", "image/jpeg" etc.
 *
 * @param actionType The Adobe360WorkflowActionType type of this instance
 * @param mediaTypes An array of NSString objects. The Internet Media Types supported by this input.
 *
...
/**
 * Collection of accepted Internet Media Types. An array of NSString objects
 * Examples of Internet Media Type include "image/png", "image/jpeg" etc.
 */
@property (strong, nonatomic, readonly) NSArray *mediaTypes;
 ...
 * @param types An array of NSString objects. The Internet Media Types supported by this input.
 *
...
/**
 * Represent an action object defined in the Action Registry.
 *
...
/**
 * List of Adobe360WorkflowActionInput objects the app provides.
 */
@property (copy, nonatomic, readonly) NSArray *inputs;

/**
 * List of support Adobe360WorkflowActionOutput objects .
 */
 ...
 *
 * @param inputToAdd The input object to add to the supported inputs.
 */
 ...
 *
 * @param outputToAdd The output object to add to the supported list.
 */
 ...
 * the thumbnailData will contain usable data that can be used by an instance of UIImage,
 * otherwise, an error will indicate any potential issues.
 */
