 ...
 */
__deprecated // AdobePSDPreviewLayerComp will be replaced by CloudPSD and/or AGC
 ...
 */
__deprecated // AdobePSDPreviewLayerNode will be replaced by CloudPSD and/or AGC
 ...
 */
__deprecated // AdobePSDPreview will be replaced by CloudPSD and/or AGC
 ...
 * \param parentLayer   The parent layer to use to begin the check.
 * \param typesMask     Types of layer nodes to check.
 * \param layerComp     The layer comp to check the nodes for.
 * \param recursive     YES to check recursively.
 *
 * \return YES if the parentLayer has visible children.
 */
- (BOOL)layerHasVisibleChildren:(AdobePSDPreviewLayerNode *)parentLayer ofTypes:(AdobePSDPreviewLayerNodeType)typesMask layerComp:(AdobePSDPreviewLayerComp *)layerComp recursively:(BOOL)recursive;
