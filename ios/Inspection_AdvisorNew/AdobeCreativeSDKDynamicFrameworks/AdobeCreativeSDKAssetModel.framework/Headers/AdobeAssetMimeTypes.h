...
/** The vendor mime type for Adobe PDF files */
extern NSString *const kAdobeMimeTypeAdobePDF;
...
/** The legacy mime type for Illustrator documents */
extern NSString *const kAdobeMimeTypeIllustratorLegacy;
...
/** Adobe XD file MIME type*/
extern NSString *const kAdobeMimeTypeAdobeXD;

/** Adobe XD Project MIME type*/
extern NSString *const kAdobeMimeTypeAdobeXDProject;

/**
 * High Efficiency Image File Format - HEVC encoded (image/heic)
 */
extern NSString *const kAdobeMimeTypeHEIC;

/**
 * High Efficiency Image File Format - Any codec (image/heif)
 */
extern NSString *const kAdobeMimeTypeHEIF;

/**
 * High Efficiency Image File Format Sequence - HEVC encoded (image/heic-sequence)
 */
extern NSString *const kAdobeMimeTypeHEICSequence;

/**
 * High Efficiency Image File Format Sequence - Any codec (image/heif-sequence)
 */
extern NSString *const kAdobeMimeTypeHEIFSequence;
