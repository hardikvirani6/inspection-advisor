...
typedef NS_ENUM (NSInteger, AdobeAssetErrorCode)
{
    ...
    /**
     * Indicates an unsupported operation. Some AdobeAsset subclasses might not support all the 
     * operations that their super classes support.
     */
    AdobeAssetErrorUnsupportedOperation = 16,
    
    /**
     * Indicates that the copy/move/rename operation for an asset failed due to an already existing 
     * asset on the server.
     */
    AdobeAssetErrorDuplicateAsset = 17
};
