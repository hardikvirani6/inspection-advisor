 ...
 * the properties.
 * @param appName   The localized name of the application
 * @param urlScheme The url scheme used for the 360 workflow
 * @param accentColor The accent color defining the look-and-feel of the application
 * @param accentContrastColor The corresponding contrast to the accent color for readability
 * @param appGroup The shared app group (if any) that this app has been configured for
 *
 * @return An instance of Adobe360ApplicationProperties
 */
