...
/** The file extension for tiff files, "tiff" */
extern NSString *const kAdobeFileExtensionTypeTIFF;

/** The file extension for tiff files, "tif" */
extern NSString *const kAdobeFileExtensionTypeTIF;
...
/** The file extension for XD files */
extern NSString *const kAdobeFileExtensionTypeAdobeXD;

/**
 * High Efficiency Image File Format - Single Image (HEVC Encoded) (.heic)
 */
extern NSString *const kAdobeFileExtensionTypeHEIC;

/**
 * High Efficiency Image File Format - Single Image (H.264 Encoded) (.avci)
 */
extern NSString *const kAdobeFileExtensionTypeAVCI;

/**
 * High Efficiency Image File Format - Any Other Codec (.heif)
 */
extern NSString *const kAdobeFileExtensionTypeHEIF;

/**
 * High Efficiency Image File Format - Sequence (HEVC Encoded) (.heics)
 */
extern NSString *const kAdobeFileExtensionTypeHEICS;

/**
 * High Efficiency Image File Format - Sequence (H.264 Encoded) (.avcs)
 */
extern NSString *const kAdobeFileExtensionTypeAVCS;

/**
 * High Efficiency Image File Format - Sequence (Any Other Codec) (.heifs)
 */
extern NSString *const kAdobeFileExtensionTypeHEIFS;
...
#endif /* ifndef AdobeAssetFileExtensionsHeader */
