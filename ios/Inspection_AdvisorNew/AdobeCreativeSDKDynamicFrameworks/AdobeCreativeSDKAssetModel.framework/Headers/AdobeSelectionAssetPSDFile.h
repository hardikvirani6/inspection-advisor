 ...
 */
@property (readonly, nonatomic, strong) AdobePSDPreviewLayerComp *layerComp __deprecated; // AdobePSDPreviewLayerComp will be replaced by CloudPSD and/or AGC
