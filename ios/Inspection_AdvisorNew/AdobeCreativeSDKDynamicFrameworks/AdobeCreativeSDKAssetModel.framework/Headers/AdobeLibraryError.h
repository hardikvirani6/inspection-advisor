...
typedef NS_ENUM (NSInteger, AdobeLibraryErrorCode)
{
    ...
    /**
     * Error while trying to sync bookmarks to the cloud.
     */
    AdobeLibraryErrorSyncBookmarksToCloud = 45,
    
    /**
     * Error when trying to restore an element that is already restored.
     */
    AdobeLibraryErrorElementAlreadyRestored = 46,

    /**
     * Error when trying to restore an element.
     */
    AdobeLibraryErrorElementRestoreFailed = 47,
    
    /**
     * Error when trying to remove an element that is already removed.
     */
    AdobeLibraryErrorElementAlreadyRemoved = 48
};
