 ...
 */
@property (assign, nonatomic, readwrite) AdobePSDBlendMode blendMode;

/**
 * Blend Opacity for this layer node
 */
@property (strong, nonatomic, readwrite) NSNumber *blendOpacity;
 ...
 */
@property (assign, nonatomic, readwrite) CGPoint pixelLayerOrigin;
 ...
 */
@property (strong, nonatomic, readwrite) AdobePSDRGBColor *fillColor;
