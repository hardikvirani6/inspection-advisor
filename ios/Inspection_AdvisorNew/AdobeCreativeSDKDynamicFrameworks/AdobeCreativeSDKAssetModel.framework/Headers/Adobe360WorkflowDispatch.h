...
/**
 * The NSOperationQueue for all asynchronous processing.
 ...
 *
 * @param url The url to verify.
 * @param handler A completion handler for determining when the message preparation is complete. May be nil.
 ...
 * @param handler The completion handler to be called upon sending of the message or error.
 ...
 * @param handler The completion handler to be called upon sending of the message or error. May be nil.
 * @return An NSProgress object tracking the progress of the url processing and message sending.
 */
