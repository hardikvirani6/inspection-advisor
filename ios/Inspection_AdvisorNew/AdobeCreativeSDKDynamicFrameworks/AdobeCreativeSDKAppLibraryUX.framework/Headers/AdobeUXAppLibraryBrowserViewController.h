...
/**
 * Defines all the callback methods that the AdobeUXAppLibraryBrowserViewController's delegate could handle.
 */
...
/**
 * AdobeUXAppLibraryBrowserViewController is the class by which the Adobe Creative Cloud App Library browsing component is invoked.
 */
