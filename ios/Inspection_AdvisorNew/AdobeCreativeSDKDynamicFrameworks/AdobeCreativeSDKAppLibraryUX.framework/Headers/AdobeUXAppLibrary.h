 ...
 *
 */
__deprecated_msg("Use AdobeUXAppLibraryBrowserViewController instead.") @interface AdobeUXAppLibrary : NSObject

/**
 * Get the Adobe UX App Library singleton.
 * @returns The singleton object.
 */
+ (AdobeUXAppLibrary *)sharedLibrary __deprecated_msg("Use AdobeUXAppLibraryBrowserViewController instead.");
 ...
 */
- (void)popupAppLibrary:(void (^)(void))successBlock
                onError:(void (^)(NSError *error))errorBlock __deprecated_msg("Use AdobeUXAppLibraryBrowserViewController instead.");
