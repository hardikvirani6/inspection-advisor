...
/**
 * Defines all the callback methods that the Asset Browser's delegate could handle.
 */
...
/**
 * AdobeUXAssetBrowserViewController is the class by which the Adobe Creative Cloud asset browsing component is invoked.
 *
 * AdobeUXAssetBrowserViewController allows clients to browse for and select assets and have them supplied back as AdobeAsset instances.
 */
