...
typedef NS_OPTIONS (NSUInteger, AdobeUXAssetBrowserOption)
{
    ...
    /**
     * Whether to filter non renderable assets
     * `EnableRenderableOnly` isn't specified, all assets will displayed.
     */
    EnableRenderableOnly = 1 << 6
...
#define AdobeUXAssetBrowserFilterWithAdobeContent @[ kAdobeMimeTypeIllustrator, kAdobeMimeTypeIllustratorLegacy ]
...
/**
 * The tint color of the asset browser, this can be customized to match the app's color
