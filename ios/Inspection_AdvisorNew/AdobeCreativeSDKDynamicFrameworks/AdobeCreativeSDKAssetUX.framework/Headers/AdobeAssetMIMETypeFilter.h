 ...
 * Array of mime types.
 */
@property (nonatomic, readonly, strong) NSArray<NSString *> *MIMETypes;
 ...
 */
- (instancetype)initWithMIMETypes:(NSArray<NSString *> *)MIMETypes filterType:(AdobeAssetMIMETypeFilterType)filterType;
